...
if ( ! function_exists( 'sight_render_handler_post' ) ) {
	/**
	 * Render the "post" portfolio area.
	 *
	 * @param array $attributes The block attributes.
	 * @param array $options    The block options.
	 */
	function sight_render_handler_post( $attributes, $options ) {
...
sight_render_handler_post( $attributes, $options );
