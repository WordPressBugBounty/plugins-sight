...
if ( ! function_exists( 'sight_render_handler_projects' ) ) {
	/**
	 * Render the "projects" portfolio area.
	 *
	 * @param array $attributes The block attributes.
	 * @param array $options    The block options.
	 */
	function sight_render_handler_projects( $attributes, $options ) {
...
sight_render_handler_projects( $attributes, $options );
