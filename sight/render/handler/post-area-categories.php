...
if ( ! function_exists( 'sight_render_handler_categories' ) ) {
	/**
	 * Render the "categories" portfolio area.
	 *
	 * @param array $attributes The block attributes.
	 * @param array $options    The block options.
	 */
	function sight_render_handler_categories( $attributes, $options ) {
...
sight_render_handler_categories( $attributes, $options );
